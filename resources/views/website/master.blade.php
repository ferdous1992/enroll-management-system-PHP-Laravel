...
<footer>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-body h-100">
                        ...
                        <hr/>
                        <p>
                            House:# Mehen Nigar, Ananda Nagar, Merul Badda<br/>
                            Dhaka - 1209 <br/>
                            Email: ferdous.cse51@gmail.com<br/>
                            Phone:01761870512
                        </p>
                        <hr/>
                        <ul class="nav">
    ...
    <section class="bg-dark py-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="text-center text-white mb-0">Design & Developed By Web Development &copy; Md. Ferdous </p>
                </div>
            </div>
        </div>
    </section>
